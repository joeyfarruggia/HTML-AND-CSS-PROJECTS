//Initialize tooltips
//Adds a popup tooltip to an element when the user hovers over it, providing additional information.

const tooltipTriggerList = document.querySelectorAll('[data-bs-toggle="tooltip"]')
tooltipTriggerList.forEach(el => new bootstrap.Tooltip(el))

//Initialize popovers
//Adds a popup box that displays additional content when the user clicks or hovers over an element. 
//In this case, it displays an image of the star rating for the selected movie.
...
//Inititalize toast
//A toast is a small, non-intrusive message that appears on the screen 
...
$(document).on("scroll", function () {
    ...
    if ($(document).scrollTop() > 50) {
        //once the 50px requirement is met, add the nav-shrink class
        //selector to the same HTML element that has the nav class
        ...
        //the nav-shrink class selector is removed from the HTML element
        //with the nav class selector.
        $("nav").removeClass("nav-shrink");
        //The margin for the drop down menu is now returned to its original position
...
$(document).ready(function () {
    ...
    //dropdown-toggle and then also close when an element with the class 
    //.dropdown-item (each movie link) is clicked
